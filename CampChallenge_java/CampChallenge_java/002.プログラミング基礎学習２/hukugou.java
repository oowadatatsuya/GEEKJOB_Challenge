 ...
 * @author kumi
 */
public class hukugou extends HttpServlet {
...
try (PrintWriter out = response.getWriter()) {
        ...
        System.out.print("情報の格納確認");
        
        db_st = db_con.prepareStatement("select * from proflies where name like ? and age=? and birthday=?");
