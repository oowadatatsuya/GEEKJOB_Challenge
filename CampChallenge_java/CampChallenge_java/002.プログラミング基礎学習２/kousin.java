 ...
 * @author kumi
 */
public class kousin extends HttpServlet {
    ...
    try (PrintWriter out = response.getWriter()) {
        ...
        String birthday = request.getParameter("birthday"); //入力された情報の変換
         ...
         db_st = db_con.prepareStatement("update proflies set name=?, tell=?, age=?, birthday=? where profilesID =? ");
