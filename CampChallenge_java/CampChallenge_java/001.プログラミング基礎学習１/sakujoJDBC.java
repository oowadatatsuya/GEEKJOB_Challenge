 ...
 * @author kumi
 */
public class sakujoJDBC extends HttpServlet {
    ...
    try (PrintWriter out = response.getWriter()) {
        ...
        db_st = db_con.prepareStatement("delete from proflies where profilesID = ?");
        db_st.setString(1, request.getParameter("id"));   //select文の入力
        System.out.print("削除確認");
        db_st.executeUpdate(); 
